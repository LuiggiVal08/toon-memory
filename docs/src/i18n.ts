		...
		features: {
			cards: [
				...
				},
				{
					icon: '🗜️',
					title: 'Compression',
					body: 'LLM-powered compression for related entries, batch cleanup of low-quality entries, and auto-injected system primer at session start.',
					stats: ['14% fewer tokens', 'Auto-primer'],
				},
				{
					icon: '🔄',
					title: 'Sync & Sessions',
...
irm https://raw.githubusercontent.com/LuiggiVal08/toon-memory/main/install.ps1 | iex`,
		...
		tools: {
			...
			cards: [
				...
				{ name: 'memory_consolidate', title: 'Consolidate', desc: 'Merge duplicate entries with identical content deterministically. Near-duplicate detection via Jaccard similarity.', group: 'search' },
...
[1] decision/risk-engine-priority
  ...
  tags: risk;spec · edges: ->2, ->3`,
		...
		whatNew: {
			...
			subtitle: 'Three major features that make your agent smarter and your memory portable',
			cards: [
				{
					icon: '🗜️',
					title: 'LLM Compression',
					body: 'Smart two-step compression: summarize entries with an LLM, then overwrite. Batch compression removes low-quality entries deterministically — no LLM needed.',
					stats: ['14% fewer tokens', 'Quality scoring'],
				},
				{
					icon: '🔄',
					title: 'GitHub Gist Sync',
					body: 'Export and import memory entries via GitHub Gists. Share context across machines, back up to the cloud, or sync between projects.',
					stats: ['Public/private gists', 'Auto-merge'],
				},
				{
					icon: '🔀',
					title: 'Cross-Session Merge',
					body: 'Merge observations from parallel agent sessions for the same file. Deduplicates, auto-promotes, and coordinates multi-agent work.',
					stats: ['Dedup detection', 'Auto-promote'],
				},
			],
		},
		cta: {
...
irm https://raw.githubusercontent.com/LuiggiVal08/toon-memory/main/install.ps1 | iex`,
	...
	tools: {
		...
		cards: [
			...
			{ name: 'memory_consolidate', title: 'Consolidar', desc: 'Combina entradas duplicadas con contenido idéntico de forma determinista. Near-duplicate detection vía similitud Jaccard.', group: 'search' },
...
[1] decision/risk-engine-priority
  ...
  tags: risk;spec · edges: ->2, ->3`,
	...
	whatNew: {
		...
		subtitle: 'Tres funcionalidades principales que hacen tu agente más inteligente y tu memoria portable',
		cards: [
			{
				icon: '🗜️',
				title: 'Compresión LLM',
				body: 'Compresión inteligente de dos pasos: resume entradas con un LLM, luego sobrescribe. La compresión por lotes elimina entradas de baja calidad de forma determinista — sin LLM.',
				stats: ['14% menos tokens', 'Puntuación de calidad'],
			},
			{
				icon: '🔄',
				title: 'Sincronización con Gist',
				body: 'Exporta e importa entradas de memoria mediante GitHub Gists. Comparte contexto entre máquinas, haz copias de seguridad en la nube o sincroniza entre proyectos.',
				stats: ['Gists públicos/privados', 'Auto-fusión'],
			},
			{
				icon: '🔀',
				title: 'Fusión entre Sesiones',
				body: 'Fusiona observaciones de sesiones paralelas de agentes para el mismo archivo. Desduplica, promueve automáticamente y coordina trabajo multi-agente.',
				stats: ['Detección de duplicados', 'Auto-promoción'],
			},
		],
	},
	cta: {
	...
	whatNew: {
		title: 'v3.0.0 新功能',
		subtitle: '三大主要功能让您的代理更智能、记忆更可移植',
		cards: [
			{
				icon: '🗜️',
				title: 'LLM 压缩',
				body: '智能两步压缩：用 LLM 摘要条目，然后覆盖。批量压缩确定性地移除低质量条目 — 无需 LLM。',
				stats: ['14% 令牌节省', '质量评分'],
			},
			{
				icon: '🔄',
				title: 'GitHub Gist 同步',
				body: '通过 GitHub Gist 导出和导入记忆条目。跨机器共享上下文、备份到云端或在项目间同步。',
				stats: ['公共/私有 Gist', '自动合并'],
			},
			{
				icon: '🔀',
				title: '跨会话合并',
				body: '合并同一文件的并行代理会话观察。去重、自动提升并协调多代理工作。',
				stats: ['重复检测', '自动提升'],
			},
		],
	},
	...
	whatNew: {
		title: 'v3.0.0の新機能',
		subtitle: 'エージェントをよりスマートに、メモリをポータブルにする3つの主要機能',
		cards: [
			{
				icon: '🗜️',
				title: 'LLM圧縮',
				body: 'インテリジェントな2ステップ圧縮：LLMでエントリを要約してから上書き。バッチ圧縮は低品質なエントリを決定論的に削除 — LLM不要。',
				stats: ['14%トークン削減', '品質スコアリング'],
			},
			{
				icon: '🔄',
				title: 'GitHub Gist同期',
				body: 'GitHub Gistでメモリエントリをエクスポート/インポート。マシン間でコンテキストを共有、クラウドにバックアップ、プロジェクト間で同期。',
				stats: ['パブリック/プライベートGist', '自動マージ'],
			},
			{
				icon: '🔀',
				title: 'クロスセッションマージ',
				body: '同じファイルの並列エージェントセッションから観察をマージ。重複除去、自動プロモート、マルチエージェント作業を調整。',
				stats: ['重複検出', '自動プロモート'],
			},
		],
	},
	...
	whatNew: {
		title: 'v3.0.0의 신 기능',
		subtitle: '에이전트를 더 스마트하게, 메모리를 이식 가능하게 만드는 3가지 주요 기능',
		cards: [
			{
				icon: '🗜️',
				title: 'LLM 압축',
				body: '지능형 2단계 압축: LLM으로 항목을 요약한 후 덮어쓰기. 배치 압축은 저품질 항목을 결정적으로 제거 — LLM 불필요.',
				stats: ['14% 토큰 절약', '품질 스코어링'],
			},
			{
				icon: '🔄',
				title: 'GitHub Gist 동기화',
				body: 'GitHub Gist를 통해 메모리 항목을 내보내기/가져오기. 머신 간 컨텍스트 공유, 클라우드 백업, 프로젝트 간 동기화.',
				stats: ['공개/비공개 Gist', '자동 병합'],
			},
			{
				icon: '🔀',
				title: '크로스 세션 병합',
				body: '동일 파일에 대한 병렬 에이전트 세션의 관찰을 병합. 중복 제거, 자동 승격, 멀티 에이전트 작업을 조율.',
				stats: ['중복 감지', '자동 승격'],
			},
		],
	},
...
[1] decision/risk-engine-priority
  ...
  tags: risk;spec · edges: ->2, ->3`,
	...
	whatNew: {
		...
		subtitle: 'Três recursos principais que tornam seu agente mais inteligente e sua memória portátil',
		cards: [
			{
				icon: '🗜️',
				title: 'Compressão LLM',
				body: 'Compressão inteligente em duas etapas: resuma entradas com um LLM, depois sobrescreva. Compressão em lote remove entradas de baixa qualidade de forma determinística — sem LLM.',
				stats: ['14% menos tokens', 'Pontuação de qualidade'],
			},
			{
				icon: '🔄',
				title: 'Sincronização com Gist',
				body: 'Exporte e importe entradas de memória via GitHub Gists. Compartilhe contexto entre máquinas, faça backup na nuvem ou sincronize entre projetos.',
				stats: ['Gists públicos/privados', 'Auto-fusão'],
			},
			{
				icon: '🔀',
				title: 'Fusão entre Sessões',
				body: 'Fusione observações de sessões paralelas de agentes para o mesmo arquivo. Deduplica, promove automaticamente e coordena trabalho multi-agente.',
				stats: ['Detecção de duplicatas', 'Auto-promoção'],
			},
		],
	},
	cta: {
...
whatNew: {
	title: 'Neu in v3.0.0',
	subtitle: 'Drei Hauptfunktionen, die Ihren Agenten klüger und Ihren Speicher portabel machen',
	cards: [
		{
			icon: '🗜️',
			title: 'LLM-Komprimierung',
			body: 'Intelligente Zwei-Schritt-Komprimierung: Fassen Sie Einträge mit einem LLM zusammen und überschreiben Sie sie. Batch-Komprimierung entfernt Einträge niedriger Qualität deterministisch — kein LLM nötig.',
			stats: ['14% weniger Tokens', 'Qualitätswertung'],
		},
		{
			icon: '🔄',
			title: 'GitHub Gist Sync',
			body: 'Exportieren und importieren Sie Speichereinträge über GitHub Gists. Teilen Sie Kontext zwischen Maschinen, sichern Sie in die Cloud oder synchronisieren Sie zwischen Projekten.',
			stats: ['Öffentliche/PRIVATE Gists', 'Auto-Fusion'],
		},
		{
			icon: '🔀',
			title: 'Cross-Session Fusion',
			body: 'Fassen Sie Beobachtungen aus parallelen Agentensitzungen für dieselbe Datei zusammen. Dedupliziert, fördert automatisch und koordiniert Multi-Agenten-Arbeit.',
			stats: ['Dedup-Erkennung', 'Auto-Förderung'],
		},
	],
},
cta: {
...
whatNew: {
	title: 'Nouveautés dans v3.0.0',
	subtitle: 'Trois fonctionnalités majeures qui rendent votre agent plus intelligent et votre mémoire portable',
	cards: [
		{
			icon: '🗜️',
			title: 'Compression LLM',
			body: 'Compression intelligente en deux étapes : résumez les entrées avec un LLM, puis écrasez. La compression par lot supprime les entrées de faible qualité de manière déterministe — sans LLM.',
			stats: ['14% moins de tokens', 'Score de qualité'],
		},
		{
			icon: '🔄',
			title: 'Synchronisation Gist',
			body: 'Exportez et importez des entrées mémoire via GitHub Gists. Partagez le contexte entre machines, sauvegardez dans le cloud ou synchronisez entre projets.',
			stats: ['Gists publics/privés', 'Auto-fusion'],
		},
		{
			icon: '🔀',
			title: 'Fusion Inter-Sessions',
			body: 'Fusionnez les observations de sessions parallèles d\'agents pour le même fichier. Déduplique, promeut automatiquement et coordonne le travail multi-agents.',
			stats: ['Détection de doublons', 'Auto-promotion'],
		},
	],
},
cta: {
