...
- **Conjunto completo de funcionalidades** — 21 ferramentas MCP, criptografia, coordenação multi-sessão
...
- **Completo** — 21 ferramentas MCP, recall por grafo, pontuação de qualidade
