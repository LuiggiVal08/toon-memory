...
- **Suporte a agentes** — 20+ agentes com configuração automática
...
|---------------|-------------|------|--------------|
| Protocolo MCP | ✅ | ❌ | ❌ |
| Suporte a agentes | 20+ | Qualquer (API) | Apenas Claude |
...
- **Agnóstico de agente** — funciona com mais de 20 agentes
