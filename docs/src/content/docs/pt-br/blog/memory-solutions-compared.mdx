...
- **Conjunto completo de funcionalidades** — 27 ferramentas MCP, criptografia, coordenação multi-sessão
...
- **Completo** — 27 ferramentas MCP, recall por grafo, pontuação de qualidade
