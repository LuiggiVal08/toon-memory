...
- **Conjunto completo de funcionalidades** — 40 ferramentas MCP, criptografia, coordenação multi-sessão
...
- **Completo** — 40 ferramentas MCP, recall por grafo, pontuação de qualidade
