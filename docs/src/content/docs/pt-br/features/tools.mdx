---
title: "27 Ferramentas MCP para Memória Persistente de IA"
description: "27 ferramentas MCP para memória persistente de agentes IA — memory_remember, memory_recall, memory_smart_recall, context_generate e mais. Recall eficiente em tokens e baseado em grafo para Claude, Cursor, OpenCode."
head:
  - tag: meta
    attrs:
      name: keywords
...
O toon-memory fornece 27 ferramentas MCP e 3 recursos MCP para gerenciar memória persistente:
