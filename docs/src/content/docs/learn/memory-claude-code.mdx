...
description: "Give Claude Code, Cursor, and OpenCode persistent memory. toon-memory MCP server works with 20+ AI coding agents. Remember decisions, patterns, and bugs between sessions."
head:
  - tag: meta
    attrs:
      name: keywords
