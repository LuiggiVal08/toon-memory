---
title: "永続AIメモリ向けの21個のMCPツール"
description: "永続AIエージェントメモリ向けの21個のMCPツール — memory_remember、memory_recall、memory_smart_recall、context_generateなど。Claude、Cursor、OpenCode向けのトークン効率の高いグラフ対応リコール。"
head:
  - tag: meta
    attrs:
      name: keywords
...
toon-memoryは永続メモリを管理するための21個のMCPツールと3つのMCPリソースを提供します：
