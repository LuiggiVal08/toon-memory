...
description: "Install toon-memory MCP memory server in 3 steps. Works with Claude, Cursor, OpenCode, Windsurf, and 20+ AI coding agents. Zero config persistent memory."
head:
  - tag: meta
    attrs:
      name: keywords
