---
title: "34 outils MCP pour la mémoire IA persistante"
description: "34 outils MCP pour la mémoire persistante des agents IA — memory_remember, memory_recall, memory_smart_recall, context_generate et plus encore. Rappel économe en tokens, basé sur le graphe, pour Claude, Cursor, OpenCode."
head:
  - tag: meta
    attrs:
      name: keywords
...
toon-memory fournit 34 outils MCP et 4 ressources MCP pour gérer la mémoire persistante :
