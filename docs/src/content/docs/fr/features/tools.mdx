---
title: "35 outils MCP pour la mémoire IA persistante"
description: "35 outils MCP pour la mémoire persistante des agents IA — memory_remember, memory_recall, memory_smart_recall, context_generate et plus encore. Rappel économe en tokens, basé sur le graphe, pour Claude, Cursor, OpenCode."
head:
  - tag: meta
    attrs:
      name: keywords
