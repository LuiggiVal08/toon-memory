...
description: Las 20 herramientas de memoria y contexto y 3 recursos para tu agente de IA
---

## Resumen

toon-memory proporciona 20 herramientas MCP y 3 recursos MCP para gestionar la memoria persistente:
