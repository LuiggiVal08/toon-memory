...
description: Las 14 herramientas de memoria y 3 recursos para tu agente de IA
---

## Resumen

toon-memory proporciona 14 herramientas MCP y 3 recursos MCP para gestionar la memoria persistente:
