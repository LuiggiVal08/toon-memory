...
description: Las 21 herramientas de memoria y contexto y 3 recursos para tu agente de IA
---

## Resumen

toon-memory proporciona 21 herramientas MCP y 3 recursos MCP para gestionar la memoria persistente:
