...
description: Las 27 herramientas de memoria y contexto y 3 recursos para tu agente de IA
---

## Resumen

toon-memory proporciona 27 herramientas MCP y 3 recursos MCP para gestionar la memoria persistente:
