---
title: "21 个 MCP 工具实现持久化 AI 记忆"
description: "21 个 MCP 工具用于 AI 代理持久化记忆 — memory_remember、memory_recall、memory_smart_recall、context_generate 等。面向 Claude、Cursor、OpenCode 的 token 高效、图感知召回。"
head:
  - tag: meta
    attrs:
      name: keywords
...
toon-memory 提供 21 个 MCP 工具和 3 个 MCP 资源，用于管理持久化记忆：
