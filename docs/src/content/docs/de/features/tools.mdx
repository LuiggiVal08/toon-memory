---
title: "34 MCP-Tools für persistenen AI-Speicher"
description: "34 MCP-Tools für persistenen AI-Agent-Speicher — memory_remember, memory_recall, memory_smart_recall, context_generate und mehr. Token-effizienter, graph-bewusster Abruf für Claude, Cursor, OpenCode."
head:
  - tag: meta
    attrs:
      name: keywords
...
toon-memory bietet 34 MCP-Tools und 4 MCP-Ressourcen zur Verwaltung des persistenten Speichers:
