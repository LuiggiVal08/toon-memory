---
title: "AES-256-GCM Encryption for AI Agent Memory"
description: "AES-256-GCM encryption for AI agent memory — protect sensitive data in toon-memory. Secure your MCP memory server with military-grade encryption."
---
...
3. Key is stored in `.toon-memory/memory/config.json`
