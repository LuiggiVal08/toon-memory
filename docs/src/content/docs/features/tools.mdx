---
title: "21 MCP Tools for Persistent AI Memory"
description: "21 MCP tools for persistent AI agent memory — memory_remember, memory_recall, memory_smart_recall, context_generate, and more. Token-efficient, graph-aware recall for Claude, Cursor, OpenCode."
head:
  - tag: meta
    attrs:
      name: keywords
...
toon-memory provides 21 MCP tools and 3 MCP resources for managing persistent memory:
