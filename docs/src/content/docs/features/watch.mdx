---
title: "Auto-Backup Mode for AI Agent Memory"
description: "Auto-backup mode for AI agent memory — periodic backups with compression and logging. Keep your MCP memory server data safe."
---
...
1. Watches `.toon-memory/memory/data.toon` for changes
2. When content changes, creates a timestamped backup
3. Backups are stored in `.toon-memory/memory/backups/`
