---
title: "AI 에이전트 영구 메모리를 위한 21개 MCP 도구"
description: "AI 에이전트 영구 메모리를 위한 21개 MCP 도구 — memory_remember, memory_recall, memory_smart_recall, context_generate 등. Claude, Cursor, OpenCode를 위한 토큰 효율적이고 그래프 인식 검색."
head:
  - tag: meta
    attrs:
      name: keywords
...
toon-memory는 영구 메모리를 관리하기 위한 21개의 MCP 도구와 3개의 MCP 리소스를 제공합니다:
