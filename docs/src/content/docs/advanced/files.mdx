---
title: "Memory File Structure"
description: "Memory file structure — .toon-memory directory layout, data.toon format, config.json, backups. How MCP memory server stores data locally."
---
