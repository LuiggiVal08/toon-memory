...
| `memory_merge_similar` | Encontrar entradas com >50% de similaridade de palavras (Jaccard) e mesclá-las deterministamente. `dryRun: true` mostra uma prévia detalhada da mesclagem |
